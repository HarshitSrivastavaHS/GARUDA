...
**Last Message:** \`${user.lastMessage?(user.lastMessage.content.length<31?user.lastMessage.content.replaceAll("`", "*"):user.lastMessage.content.substr(0,31).replaceAll("`", "**")+"..."):"None"}\`\n\
