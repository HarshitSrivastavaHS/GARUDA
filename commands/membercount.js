...
module.exports = {
    ...
    async execute(message, args, bot, Discord, prefix) {
        if (args.length!=0) {
	    if (!message.member.permissions.has("MANAGE_GUILD")) return message.reply(`You cannot access subcommands, you need manage server permission. To view membercount, please run ${prefix}membercount`)
            if (args[0] == "goalset") {
